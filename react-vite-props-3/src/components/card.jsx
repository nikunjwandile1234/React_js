  ...
  return (
    <div className="flex items-center justify-center p-6">
      <div className="relative bg-gradient-to-br from-gray-900/90 via-gray-800/70 to-black/90 backdrop-blur-lg 
        ...
        {/* Header Neon Bar */}
        <div className="absolute top-0 left-0 w-full h-24 bg-gradient-to-r from-pink-500 to-purple-700 rounded-t-2xl blur-[1px] opacity-80" />

        {/* Profile Image */}
        <div className="relative flex justify-center mt-10">
          <div className="absolute inset-0 flex justify-center">
            <div className="w-32 h-32 bg-gradient-to-tr from-pink-500 via-purple-500 to-blue-500 rounded-full blur-2xl opacity-50" />
          </div>
          <img
            src={imageurl}
            alt="Profile"
        ...
        <div className="flex flex-col gap-3 items-center mb-6">
          <button
            ...
            className="px-8 py-2 bg-gradient-to-r from-pink-500 to-purple-700 rounded-full 
          ...
          <a
            href={viewprofileurl || "#"}
            target={viewprofileurl ? "_blank" : undefined}
            rel={viewprofileurl ? "noopener noreferrer" : undefined}
            aria-label={viewprofileurl ? `View ${username}'s profile` : `No profile available`}
